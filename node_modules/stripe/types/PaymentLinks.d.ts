...
declare module 'stripe' {
  namespace Stripe {
     ...
     *
     * Related guide: [com.example.festapp_ofc.Payment Links API](https://stripe.com/docs/payment-links)
     */
    interface PaymentLink {
      ...
      /**
       * The ID of the Connect application that created the com.example.festapp_ofc.Payment Link.
       */
      application:
        | string
        | Stripe.Application
    ...
    namespace PaymentLink {
      ...
      interface PaymentIntentData {
        ...
        /**
         * Set of [key-value pairs](https://stripe.com/docs/api/metadata) that will set metadata on [com.example.festapp_ofc.Payment Intents](https://stripe.com/docs/api/payment_intents) generated from this payment link.
         */
        metadata: Stripe.Metadata;
