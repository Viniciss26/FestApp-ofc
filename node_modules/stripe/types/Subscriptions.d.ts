...
declare module 'stripe' {
  namespace Stripe {
    ...
    interface Subscription {
      ...
      /**
       * com.example.festapp_ofc.Payment settings passed on to invoices created by the subscription.
       */
    ...
    namespace Subscription {
      ...
      interface PaymentSettings {
        /**
         * com.example.festapp_ofc.Payment-method-specific configuration to provide to invoices created by the subscription.
         */
