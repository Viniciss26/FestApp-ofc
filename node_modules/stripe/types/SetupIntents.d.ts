...
declare module 'stripe' {
  namespace Stripe {
    ...
    interface SetupIntent {
       ...
       *
       * If present, the SetupIntent's payment method will be attached to the Customer on successful setup. com.example.festapp_ofc.Payment methods attached to other Customers cannot be used with this SetupIntent.
       */
      ...
      /**
       * com.example.festapp_ofc.Payment method-specific configuration for this SetupIntent.
       */
    ...
    namespace SetupIntent {
      ...
      interface LastSetupError {
         ...
         *
         * Related guide: [com.example.festapp_ofc.Payment Intents API](https://stripe.com/docs/payments/payment-intents)
         */
         ...
         *
         * Related guides: [com.example.festapp_ofc.Payment Methods](https://stripe.com/docs/payments/payment-methods) and [More com.example.festapp_ofc.Payment Scenarios](https://stripe.com/docs/payments/more-payment-scenarios).
         */
