  ...
  namespace Stripe {
    ...
    namespace TokenCreateParams {
      ...
      interface BankAccount {
        ...
        /**
         * The ID of a com.example.festapp_ofc.Payment Method with a `type` of `us_bank_account`. The com.example.festapp_ofc.Payment Method's bank account information will be copied and returned as a Bank Account Token. This parameter is exclusive with respect to all other parameters in the `bank_account` hash. You must include the top-level `customer` parameter if the com.example.festapp_ofc.Payment Method is attached to a `Customer` object. If the com.example.festapp_ofc.Payment Method is not attached to a `Customer` object, it will be consumed and cannot be used again. You may not use com.example.festapp_ofc.Payment Methods which were created by a Setup Intent with `attach_to_self=true`.
         */
