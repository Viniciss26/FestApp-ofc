...
declare module 'stripe' {
  namespace Stripe {
    namespace Checkout {
       ...
       * or [com.example.festapp_ofc.Payment Links](https://stripe.com/docs/payments/payment-links). We recommend creating a
      ...
      interface Session {
        ...
        /**
         * The ID of the com.example.festapp_ofc.Payment Link that created this Session.
         */
        ...
        /**
         * com.example.festapp_ofc.Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
         */
