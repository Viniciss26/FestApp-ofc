  ...
  namespace Stripe {
    ...
    namespace CustomerCashBalanceTransaction {
      ...
      interface AppliedToPayment {
        /**
         * The [com.example.festapp_ofc.Payment Intent](https://stripe.com/docs/api/payment_intents/object) that funds were applied to.
         */
      ...
      interface UnappliedFromPayment {
        /**
         * The [com.example.festapp_ofc.Payment Intent](https://stripe.com/docs/api/payment_intents/object) that funds were unapplied from.
         */
        payment_intent: string | Stripe.PaymentIntent;
      }
    }
