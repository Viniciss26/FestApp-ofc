...
declare module 'stripe' {
  namespace Stripe {
    ...
    interface ConfirmationToken {
      ...
      /**
       * com.example.festapp_ofc.Payment-method-specific configuration for this ConfirmationToken.
       */
      payment_method_options: ConfirmationToken.PaymentMethodOptions | null;

      /**
       * com.example.festapp_ofc.Payment details collected by the com.example.festapp_ofc.Payment Element, used to create a PaymentMethod when a PaymentIntent or SetupIntent is confirmed with this ConfirmationToken.
       */
    ...
    namespace ConfirmationToken {
      ...
      namespace PaymentMethodOptions {
        interface Card {
          /**
           * The `cvc_update` Token collected from the com.example.festapp_ofc.Payment Element.
           */
